...
internal class LoginWithUserNameUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: AuthRepository,
) : LoginWithUserNameUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: LoginWithUserNameRequest): Flow<RestResult<Unit>> = prepare {
        repository.loginWithUserName(body = params)
    }
}
