 ...
 */
package com.iamkurtgoz.feature.auth.loginWithEmail.data.useCase
...
internal class LoginWithEmailUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: AuthRepository,
) : LoginWithEmailUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: LoginWithEmailRequest): Flow<RestResult<Unit>> = prepare {
        repository.loginWithEmail(body = params)
    }
}
