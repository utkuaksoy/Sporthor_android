...
internal class AuthScreenContract {
    @Immutable
    data class State(
    ...
    sealed class SideEffect : CoreState.SideEffect {
        ...
        data class NavigateToHome(val isNewRegisteredUser: Boolean) : SideEffect()
    }

    sealed class Event : CoreState.Event {
        data object Initialize : Event()
        data object DismissDialogs : Event()
        data class NavigateToHome(val isNewRegisteredUser: Boolean) : Event()
    }
