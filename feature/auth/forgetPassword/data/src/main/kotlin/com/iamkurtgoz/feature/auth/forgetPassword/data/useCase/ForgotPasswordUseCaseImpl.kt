 ...
 */
package com.iamkurtgoz.feature.auth.forgetPassword.data.useCase
...
) : ForgotPasswordUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: ForgotPasswordRequest): Flow<RestResult<Unit>> = prepare {
        repository.forgotPassword(body = params)
    }
}
