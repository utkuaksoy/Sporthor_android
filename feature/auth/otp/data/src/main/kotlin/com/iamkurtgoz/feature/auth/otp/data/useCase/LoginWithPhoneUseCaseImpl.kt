 ...
 */
package com.iamkurtgoz.feature.auth.otp.data.useCase
...
internal class LoginWithPhoneUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: AuthRepository,
) : LoginWithPhoneUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: LoginWithPhoneRequest): Flow<RestResult<Unit>> = prepare {
        repository.loginWithPhone(body = params)
    }
}
