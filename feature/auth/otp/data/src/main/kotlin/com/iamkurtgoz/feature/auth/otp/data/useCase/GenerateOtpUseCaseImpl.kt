...
internal class GenerateOtpUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: AuthRepository,
) : GenerateOtpUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: GenerateOtpRequest): Flow<RestResult<Unit>> = prepare {
        repository.generateOtp(body = params)
    }
}
