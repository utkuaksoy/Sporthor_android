...
internal class ValidateOtpUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: AuthRepository,
) : ValidateOtpUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: ValidateOtpRequest): Flow<RestResult<Unit>> = prepare {
