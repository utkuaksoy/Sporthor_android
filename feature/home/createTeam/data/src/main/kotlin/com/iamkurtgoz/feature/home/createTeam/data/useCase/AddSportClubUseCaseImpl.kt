 ...
 */
package com.iamkurtgoz.feature.home.createTeam.data.useCase
...
import com.iamkurtgoz.feature.home.createTeam.data.mapper.ClubUIMapper
...
internal class AddSportClubUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: ManagerRepository,
    private val clubUIMapper: ClubUIMapper,
) : AddSportClubUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: AddSportClubRequest?): Flow<RestResult<ClubUIModel>> = prepare {
        repository.addSportClub(params)
