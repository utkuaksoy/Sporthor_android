...
import com.iamkurtgoz.feature.home.calendarDetail.data.mapper.CalendarDetailEventUIMapper
...
internal class GetCalendarDetailUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: CalendarRepository,
    private val calendarDetailEventUIMapper: CalendarDetailEventUIMapper,
) : GetCalendarDetailUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: String?): Flow<RestResult<CalendarDetailEventUIModel>> = prepare {
        repository.getCalendarDetail(params).mapOnSuccess(calendarDetailEventUIMapper::map)
    }
}
