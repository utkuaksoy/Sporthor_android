 ...
 */
package com.iamkurtgoz.feature.home.editTrainingGroup.navigation
...
import com.iamkurtgoz.core.navigation.model.home.editTrainingGroup.homeScreenEditTrainingGroupScreenRouteMap
...
import com.iamkurtgoz.feature.home.editTrainingGroup.EditTrainingGroupScreen

fun NavGraphBuilder.editTrainingGroupScreenNavigation(
    navigateUp: () -> Unit,
    popBackStack: () -> Unit,
    navigateToHome: () -> Unit,
    ...
    composable<HomeScreenEditTrainingGroupScreenRoute>(
        typeMap = homeScreenEditTrainingGroupScreenRouteMap,
    ) {
        EditTrainingGroupScreen(
...
fun NavController.navigateToEditTrainingGroupScreen(model: HomeScreenEditTrainingGroupScreenNavigationModel, fromTrainingGroup: Boolean = false, navOptions: NavOptions? = null) {
    val route = HomeScreenEditTrainingGroupScreenRoute(
        model = model,
