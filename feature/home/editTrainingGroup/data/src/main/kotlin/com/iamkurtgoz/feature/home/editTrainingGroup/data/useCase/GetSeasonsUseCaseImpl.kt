...
import com.iamkurtgoz.feature.home.editTrainingGroup.data.mapper.GetSeasonsUIMapper
...
internal class GetSeasonsUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: ConfigurationRepository,
    private val getSeasonsUIMapper: GetSeasonsUIMapper,
) : GetSeasonsUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(): Flow<RestResult<List<GetSeasonsUIModel>>> = prepare {
        repository.getSeasons()
            .mapOnSuccess {
                it.map(getSeasonsUIMapper::map)
            }
    }
}
