...
internal class OnboardingScreenContract {
    @Immutable
    data class State(
        ...
        val pageList: List<OnBoardingPageItemUIModel> = listOf(),
        val currentPageIndex: Int = AppDefaults.ZERO,
    ) : CoreState.ViewState

    sealed class SideEffect : CoreState.SideEffect {
        data object NavigateUp : SideEffect()
        data object PopBackStack : SideEffect()
        data object NavigateToUserTeams : SideEffect()
