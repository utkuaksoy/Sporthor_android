...
internal class CreatePostUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: SocialRepository,
) : CreatePostUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: CreatePostRequest): Flow<RestResult<Unit>> = prepare {
        repository.createPost(params).mapOnSuccess { }
    }
}
