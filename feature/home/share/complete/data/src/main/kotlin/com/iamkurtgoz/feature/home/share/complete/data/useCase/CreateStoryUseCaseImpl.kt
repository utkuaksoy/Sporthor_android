...
internal class CreateStoryUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: SocialRepository,
) : CreateStoryUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: CreateStoryRequest): Flow<RestResult<Unit>> = prepare {
        repository.createStory(params).mapOnSuccess { }
    }
}
