...
internal class VideoUploadUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: UploadRepository,
) : VideoUploadUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: VideoUploadUseCaseParams): Flow<RestResult<List<String>>> = prepare {
        repository.videoUpload(
            files = params.files,
