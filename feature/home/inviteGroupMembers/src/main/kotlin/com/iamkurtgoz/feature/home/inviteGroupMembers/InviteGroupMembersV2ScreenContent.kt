...
@Composable
internal fun InviteGroupMembersV2ScreenContent(
                ...
                UserRow(
                    ...
                    trailingContent = {
                        AppRadioButton.Secondary(
                            ...
                            onClick = {
                                setEvent(InviteGroupMembersScreenContract.Event.ChangeSelectedUserState(item, state.selectedTab))
                            },
                        )
                    },
                    onClickAction = {
...
private fun Preview() {
    AppTheme {
        AppThemeSurface {
            InviteGroupMembersV2ScreenContent(
                state = InviteGroupMembersScreenContract.State(
                    isLoading = true,
