 ...
 */
package com.iamkurtgoz.feature.home.search.data.useCase
...
import com.iamkurtgoz.feature.home.search.data.mapper.SocialSearchHistoryUIMapper
...
internal class SearchHistoryUseCaseImpl @Inject constructor(
    ...
    private val socialSearchHistoryUIMapper: SocialSearchHistoryUIMapper,
) : SearchHistoryUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: Unit): Flow<RestResult<SearchHistoryUIModel>> = prepare {
        repository.getSearchHistory()
            .mapOnSuccess {
                socialSearchHistoryUIMapper.map(
                    it,
                )
            }
    }
