...
internal class RemoveSearchHistoryUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: SocialRepository,
) : RemoveSearchHistoryUseCase, CoreUseCase(coroutineDispatcher) {
    override fun invoke(params: RemoveSearchHistoryRequest): Flow<RestResult<Unit>> = prepare {
        repository.removeSearchHistory(body = params)
    }
}
