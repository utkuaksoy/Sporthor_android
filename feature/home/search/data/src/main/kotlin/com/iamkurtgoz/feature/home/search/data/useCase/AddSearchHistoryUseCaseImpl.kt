...
internal class AddSearchHistoryUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: SocialRepository,
) : AddSearchHistoryUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: AddSearchHistoryRequest): Flow<RestResult<Unit>> = prepare {
        repository.addSearchHistory(body = params)
    }
}
