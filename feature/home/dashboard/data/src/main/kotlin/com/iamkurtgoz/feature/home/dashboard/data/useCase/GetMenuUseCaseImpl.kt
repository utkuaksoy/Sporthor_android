...
import com.iamkurtgoz.feature.home.dashboard.data.mapper.MenuUIMapper
...
internal class GetMenuUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: ConfigurationRepository,
    private val menuUIMapper: MenuUIMapper,
) : MenuUseCase, CoreUseCase(coroutineDispatcher) {
    override fun invoke(): Flow<RestResult<MenuUIModel>> = prepare {
        repository.getMenu()
            .mapOnSuccess {
                menuUIMapper.map(it)
            }
