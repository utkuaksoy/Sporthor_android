...
import com.iamkurtgoz.feature.home.dashboard.data.mapper.DashboardFeedAsyncUIMapper
...
internal class DashboardFeedUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: SocialRepository,
    private val dashboardFeedAsyncUIMapper: DashboardFeedAsyncUIMapper,
) : DashboardFeedAsyncUseCase, CoreUseCase(coroutineDispatcher) {
    override fun invoke(params: DashboardFeedAsyncUseCaseParams): Flow<RestResult<GetFeedAsyncUIModel>> = prepare {
        repository.getFeedAsync(page = params.page, pageSize = params.pageSize)
            .mapOnSuccess {
