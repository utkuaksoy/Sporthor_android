...
internal class DeletePostUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: SocialRepository,
) : DeletePostUseCase, CoreUseCase(coroutineDispatcher) {
    override fun invoke(params: DeletePostRequest): Flow<RestResult<Unit>> = prepare {
        repository.deletePost(params)
    }
}
