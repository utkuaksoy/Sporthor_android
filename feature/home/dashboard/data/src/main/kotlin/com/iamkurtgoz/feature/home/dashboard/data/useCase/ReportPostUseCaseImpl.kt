...
internal class ReportPostUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: SocialRepository,
) : ReportPostUseCase, CoreUseCase(coroutineDispatcher) {
    override fun invoke(params: ReportPostRequest): Flow<RestResult<Unit>> = prepare {
        repository.reportPost(params)
    }
}
