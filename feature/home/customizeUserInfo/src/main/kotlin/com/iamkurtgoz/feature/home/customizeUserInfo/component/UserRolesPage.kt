...
internal fun UserRolesPage(
    ...
    Column(
        ...
        Text(
            text = stringResource(resourcesR.string.customizeuserinfoscreen_label_user_role_title),
        ...
        if (state.userRoleTypeList != null) {
            InfiniteGridList(
                ...
                rowContent = { index, item ->
                    SelectableCard.Primary(
                        ...
                        onSelect = {
                            val event = CustomizeUserInfoScreenContract.Event.SetSelectedUserRoleType(type = item)
