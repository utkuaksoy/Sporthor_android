...
internal class ConfirmationTrainingGroupUserUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: CoachRepository,
) : ConfirmationTrainingGroupUserUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: ConfirmationTrainingGroupUserRequest): Flow<RestResult<Unit>> = prepare {
        repository.confirmationTrainingGroupUser(params)
    }
}
