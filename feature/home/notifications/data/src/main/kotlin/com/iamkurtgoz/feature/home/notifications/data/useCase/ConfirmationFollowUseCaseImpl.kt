...
internal class ConfirmationFollowUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: SocialRepository,
) : ConfirmationFollowUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: ConfirmationFollowRequest): Flow<RestResult<Unit>> = prepare {
        repository.confirmationFollow(params)
    }
}
