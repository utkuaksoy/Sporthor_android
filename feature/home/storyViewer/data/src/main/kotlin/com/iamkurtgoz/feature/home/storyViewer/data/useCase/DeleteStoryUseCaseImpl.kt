...
class DeleteStoryUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: SocialRepository,
) : DeleteStoryUseCase, CoreUseCase(coroutineDispatcher){
    override fun invoke(params: DeleteStoryRequest): Flow<RestResult<Unit>> = prepare {
        repository.deleteStory(params).mapOnSuccess {  }
    }
}
