...
class WatchedStoryUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: SocialRepository,
) : WatchedStoryUseCase, CoreUseCase(coroutineDispatcher) {
    
    override fun invoke(params: WatchedStoryRequest): Flow<RestResult<Unit>> = prepare {
        repository.watchedStory(params).mapOnSuccess {  }
    }
