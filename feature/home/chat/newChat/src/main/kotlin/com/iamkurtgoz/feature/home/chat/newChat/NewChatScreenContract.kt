...
internal class NewChatScreenContract {
    @Immutable
    data class State(
    ...
    sealed class SideEffect : CoreState.SideEffect {
        ...
        data object NavigateToNewGroupChat : SideEffect()
    }
    ...
    sealed class Event : CoreState.Event {
        ...
        data object CreateGroupChat : Event()
        data object CreateCommunity : Event()
        data object ConnectContacts : Event()
        data class GenerateChatGroup(val item: MyFriendsFriendItemUIModel) : Event()
    }
