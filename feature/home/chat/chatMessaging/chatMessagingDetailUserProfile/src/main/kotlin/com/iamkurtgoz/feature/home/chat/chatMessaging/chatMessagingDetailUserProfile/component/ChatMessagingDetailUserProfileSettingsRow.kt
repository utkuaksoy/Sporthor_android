...
@Composable
internal fun ChatMessagingDetailUserProfileSettingsRow(
    mediaCount: Int?,
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = mediaCount.toString(), // TODO: Localize
                style = AppTheme.typography.subtitleSmall,
                color = AppTheme.colors.generalColors.textPrimary,
                modifier = Modifier
                    .padding(horizontal = AppTheme.spacing.spacingSmall),
        ...
        Row(
            ...
            Image(
                painter = painterResource(resourcesR.drawable.img_home_button_chat_un_selected),
                contentDescription = null,
                modifier = Modifier
                    .size(AppTheme.dimens.dp24),
            )
            ...
            Text(
                text = "Sohbeti Temizle", // TODO: Localize
                style = AppTheme.typography.subtitleSmall,
                color = AppTheme.colors.generalColors.textPrimary,
                modifier = Modifier
                    .padding(horizontal = AppTheme.spacing.spacingSmall)
