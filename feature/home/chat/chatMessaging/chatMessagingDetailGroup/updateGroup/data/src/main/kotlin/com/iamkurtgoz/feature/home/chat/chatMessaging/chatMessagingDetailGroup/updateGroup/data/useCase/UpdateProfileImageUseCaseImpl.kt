...
internal class UpdateProfileImageUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: ProfileRepository,
) : UpdateProfileImageUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: UpdateProfileImageRequest): Flow<RestResult<Unit>> = prepare {
        repository.updateProfileImage(params)
    }
}
