...
internal class UpdateChatGroupUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: ChatRepository,
) : UpdateChatGroupUseCase, CoreUseCase(coroutineDispatcher) {
    override fun invoke(params: UpdateChatGroupRequest): Flow<RestResult<Unit>> = prepare {
        repository.updateChatGroup(params)
    }
}
