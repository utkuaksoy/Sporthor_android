...
internal fun ChatMessagingDetailGroupTopRow(
    ...
    Column(
        ...
        Text(
            ...
            text = "Grup - $memberCount Üye", // TODO: Localize
        ...
        Text(
            modifier = Modifier
                ...
                .clickable {
                    setEvent.invoke(ChatMessagingDetailGroupScreenContract.Event.NavigateToUpdateGroup(groupId = groupId))
                },
            text = "Grup adı ve simgesini değiştirin", // TODO: Localize
