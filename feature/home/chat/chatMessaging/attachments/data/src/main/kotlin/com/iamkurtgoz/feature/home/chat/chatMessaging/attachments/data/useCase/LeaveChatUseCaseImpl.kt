...
internal class LeaveChatUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: ChatRepository,
) : LeaveChatUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: LeaveChatRequest): Flow<RestResult<Unit>> = prepare {
        repository.leaveChat(params)
    }
}
