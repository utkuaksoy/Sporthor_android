 ...
 */
package com.iamkurtgoz.feature.home.chat.chatMessaging.data.useCase
...
import com.iamkurtgoz.feature.home.chat.chatMessaging.data.mapper.ChatMessageUIMapper
...
) : GetMessagesUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: GetMessagesUseCaseParams?): Flow<RestResult<ChatMessageUIModel>> = prepare {
        repository.getMessages(page = params?.page, channelId = params?.channelId, orderBy = params?.orderBy)
            .mapOnSuccess(chatMessageUIMapper::map)
    }
}
