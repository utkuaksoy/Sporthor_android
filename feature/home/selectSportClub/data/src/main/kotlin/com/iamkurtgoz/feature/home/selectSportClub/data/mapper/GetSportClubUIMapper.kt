 ...
 */
package com.iamkurtgoz.feature.home.selectSportClub.data.mapper
...
@Singleton
internal class GetSportClubUIMapper @Inject constructor() : IMapper<GetSportClubDomainModel, GetSportClubUIModel> {

    override fun map(response: GetSportClubDomainModel): GetSportClubUIModel {
        return GetSportClubUIModel(
