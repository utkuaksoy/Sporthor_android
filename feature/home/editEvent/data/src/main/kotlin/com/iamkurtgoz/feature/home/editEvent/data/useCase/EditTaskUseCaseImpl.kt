...
internal class EditTaskUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: CalendarRepository,
) : EditTaskUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: UpdateTaskRequest): Flow<RestResult<Unit>> = prepare {
