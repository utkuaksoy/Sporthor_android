...
import com.iamkurtgoz.feature.home.trainingScreen.data.mapper.AddTrainingGroupUIMapper
...
internal class AddTrainingGroupUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: CoachRepository,
    private val mapper: AddTrainingGroupUIMapper,
) : AddTrainingGroupUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: AddTrainingGroupRequest): Flow<RestResult<AddTrainingGroupUIModel>> = prepare {
        repository.addTrainingGroup(params)
