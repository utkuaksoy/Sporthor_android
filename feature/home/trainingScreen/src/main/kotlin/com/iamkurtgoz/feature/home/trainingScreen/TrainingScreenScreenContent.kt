...
@Composable
internal fun TrainingScreenScreenContent(
    ...
    LazyColumn(
        ...
        item {
            AppCircleButton.SecondaryGrayLarge(
                ...
                onClick = {
                    setEvent.invoke(TrainingScreenScreenContract.Event.NavigateUp)
                },
                modifier = Modifier
        ...
        item {
            Text(
                text = "Harika! Şimdi antrenman grubunu oluştur.", // TODO: Localize
        ...
        item {
            Text(
                text = "Antrenman grubunu oluştur ve devam et.", // TODO: Localize
        ...
        item {
            SelectedClubSection(
                modifier = Modifier
                    ...
                    .padding(horizontal = AppTheme.spacing.spacingHuge),
                clubName = state.selectedClub?.clubName ?: "-",
                clubLogo = state.selectedClub?.logo ?: "",
                onChangeClick = {
                    setEvent.invoke(TrainingScreenScreenContract.Event.ShowChangeClubDialog)
                },
                showChangeButton = !state.route.fromTrainingGroup,
            )
        }
        ...
        item {
            Row(
                modifier = Modifier
                    ...
                    .clickable {
                        setEvent.invoke(TrainingScreenScreenContract.Event.ShowSelectSeasonDialog)
                    },
        ...
        item {
            AppTextField.Primary(
                ...
                onValueChange = {
                    setEvent.invoke(TrainingScreenScreenContract.Event.SetGroupName(it))
                },
