 ...
 */
package com.iamkurtgoz.feature.home.profile.profileEdit.data.useCase
...
import com.iamkurtgoz.feature.home.profile.profileEdit.data.mapper.EditProfileUIMapper
...
internal class GetProfileSummaryUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: ProfileRepository,
    private val editProfileUIMapper: EditProfileUIMapper,
) : GetProfileSummaryUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(): Flow<RestResult<EditProfileSummaryUIModel>> = prepare {
        repository.getProfileSummary()
            .mapOnSuccess {
                editProfileUIMapper.map(it)
            }
    }
}
