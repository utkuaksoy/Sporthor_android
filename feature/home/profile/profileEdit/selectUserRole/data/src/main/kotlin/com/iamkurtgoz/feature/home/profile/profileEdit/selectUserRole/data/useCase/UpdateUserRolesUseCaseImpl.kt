...
internal class UpdateUserRolesUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: ProfileRepository,
) : UpdateUserRolesUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: UpdateUserRolesRequest): Flow<RestResult<Unit>> = prepare {
        repository.updataUserRoles(body = params)
    }
}
