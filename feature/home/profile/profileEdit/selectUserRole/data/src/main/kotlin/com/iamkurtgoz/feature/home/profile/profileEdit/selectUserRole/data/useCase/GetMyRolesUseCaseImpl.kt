...
internal class GetMyRolesUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: ProfileRepository,
) : GetMyRolesUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(): Flow<RestResult<List<String>>> = prepare {
        repository.getMyRoles()
    }
}
