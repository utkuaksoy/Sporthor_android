...
@Composable
internal fun ProfileEditTeamRow(
    teams: List<TeamItemResponseUIModel>?,
    modifier: Modifier = Modifier,
    teamRowInfo: String? = null,
) {
    Column(
        modifier = modifier,
    ) {
        ...
        Row(
            ...
            Image(
                ...
                painter = painterResource(id = resourceR.drawable.img_info),
...
private fun Preview() {
    AppTheme {
        AppThemeScaffold {
            ProfileEditTeamRow(
                teamRowInfo = "Kulüp bilgileri antrenör ve yetkililer tarafından sağlanır",
                teams = MockEditProfileSummaryUIModel.mockEditProfileSummary.teamInfo?.teams,
            )
        }
    }
}
