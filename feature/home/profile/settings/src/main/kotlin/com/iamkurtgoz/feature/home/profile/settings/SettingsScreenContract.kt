...
internal class SettingsScreenContract {
    @Immutable
    data class State(
    ...
    sealed class SideEffect : CoreState.SideEffect {
        ...
        data object NavigateToAboutUs : SideEffect()
        data object NavigateToAccountSettings : SideEffect()
    ...
    sealed class Event : CoreState.Event {
        ...
        data object NavigateToAboutUs : Event()
        data object NavigateToAccountSettings : Event()
