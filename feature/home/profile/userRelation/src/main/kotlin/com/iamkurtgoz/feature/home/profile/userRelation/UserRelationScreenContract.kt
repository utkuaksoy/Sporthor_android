...
internal class UserRelationScreenContract {
    @Immutable
    data class State(
    ...
    sealed class Event : CoreState.Event {
        ...
        data class SetSelectedTabIndex(val index: Int) : Event()
        data class ChangeFollowStatus(val userActionFollowType: UserActionFollowType, val userId: String?) : Event()
        data class UpdateEventBusStatus(val eventBusState: ProfileUserRelationEventBus.Event) : Event()
    }
