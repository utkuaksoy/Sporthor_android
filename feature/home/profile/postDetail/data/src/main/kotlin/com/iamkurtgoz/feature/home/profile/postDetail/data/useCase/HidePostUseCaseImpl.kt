...
internal class HidePostUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: SocialRepository,
) : HidePostUseCase, CoreUseCase(coroutineDispatcher) {
    override fun invoke(params: HidePostRequest): Flow<RestResult<Unit>> = prepare {
        repository.hidePost(params)
    }
}
