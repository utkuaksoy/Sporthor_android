...
import com.iamkurtgoz.feature.home.profile.data.mapper.ProfileUIMapper
...
) : GetProfileUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: String?): Flow<RestResult<ProfileUIModel>> = prepare {
        repository.getProfile(params)
            .mapOnSuccess {
                profileUIMapper.map(it)
            }
    }
}
