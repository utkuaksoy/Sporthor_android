...
import com.iamkurtgoz.feature.home.profile.data.mapper.ProfileDetailUIMapper
...
internal class GetProfileDetailUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: ProfileRepository,
    private val profileDetailUIMapper: ProfileDetailUIMapper,
) : GetProfileDetailUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: String?): Flow<RestResult<ProfileDetailUIModel>> = prepare {
        repository.getProfileDetail(params)
            .mapOnSuccess {
                profileDetailUIMapper.map(it)
            }
    }
}
