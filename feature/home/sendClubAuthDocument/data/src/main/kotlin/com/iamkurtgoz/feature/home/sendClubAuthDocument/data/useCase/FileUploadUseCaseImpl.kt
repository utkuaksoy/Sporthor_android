...
internal class FileUploadUseCaseImpl @Inject constructor(
    @IoDispatcher coroutineDispatcher: CoroutineDispatcher,
    private val repository: UploadRepository,
) : FileUploadUseCase, CoreUseCase(coroutineDispatcher) {

    override fun invoke(params: FileUploadUseCaseParams): Flow<RestResult<List<String>>> = prepare {
