 ...
 */
package com.iamkurtgoz.core.navigation.model.home.sendClubAuthDocument
...
@Serializable
@Parcelize
data class HomeScreenSendClubAuthDocumentScreenNavigateModel(
...
val homeScreenSendClubAuthDocumentRouteTypeMap = mapOf(
    typeOf<HomeScreenSendClubAuthDocumentScreenNavigateModel>() to CustomNavType(
        HomeScreenSendClubAuthDocumentScreenNavigateModel::class.java,
        HomeScreenSendClubAuthDocumentScreenNavigateModel.serializer(),
    ),
)

fun SavedStateHandle.toHomeScreenSendClubAuthDocumentRoute(): HomeScreenSendClubAuthDocumentRoute {
    return this.toRoute<HomeScreenSendClubAuthDocumentRoute>(
