 ...
 */
package com.iamkurtgoz.core.navigation.model.home.successDocumentUploadScreen
...
@Serializable
@Parcelize
data class HomeScreenSuccessDocumentUploadScreenNavigateModel(
...
val homeScreenSuccessDocumentUploadRouteTypeMap = mapOf(
    typeOf<HomeScreenSuccessDocumentUploadScreenNavigateModel>() to CustomNavType(
        HomeScreenSuccessDocumentUploadScreenNavigateModel::class.java,
        HomeScreenSuccessDocumentUploadScreenNavigateModel.serializer(),
    ),
)

fun SavedStateHandle.toHomeScreenSuccessDocumentUploadRoute(): HomeScreenSuccessDocumentUploadRoute {
    return this.toRoute<HomeScreenSuccessDocumentUploadRoute>(
