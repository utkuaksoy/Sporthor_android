...
object CountDownTimerSizes {
    @Composable
    fun primary(
        height: Dp = AppTheme.dimens.dp48,
        gapSize: Dp = AppTheme.dimens.dp4,
        textSpacer: Dp = AppTheme.dimens.dp10,
    ...
    ) = remember(height, gapSize, textSpacer, contentPadding, textPadding) {
        TimerSizes(
            height = height,
            gapSize = gapSize,
