...
object AppButtonBorders {
    ...
    fun outlineBorders(
        ...
        strokeColor: Color = AppTheme.colors.buttonColors.outlineColors.buttonOutlineEnabledBorder,
        disabledColor: Color = AppTheme.colors.buttonColors.outlineColors.buttonOutlineDisabledBorder,
    ) = remember(width, strokeColor, disabledColor) {
        ButtonBorders(
            stroke = BorderStroke(width, strokeColor),
            disabled = BorderStroke(width, disabledColor),
