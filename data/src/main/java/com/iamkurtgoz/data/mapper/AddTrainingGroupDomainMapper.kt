...
@Singleton
internal class AddTrainingGroupDomainMapper @Inject constructor() : IMapper<AddTrainingGroupResponseModel, AddTrainingGroupDomainModel> {

    override fun map(response: AddTrainingGroupResponseModel): AddTrainingGroupDomainModel {
        return AddTrainingGroupDomainModel(
