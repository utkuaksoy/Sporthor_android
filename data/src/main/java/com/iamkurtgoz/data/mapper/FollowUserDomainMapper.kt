...
internal class FollowUserDomainMapper @Inject constructor() : IMapper<FollowUserResponseModel, FollowUserDomainModel> {
    override fun map(response: FollowUserResponseModel): FollowUserDomainModel {
        return with(response) {
            FollowUserDomainModel(
