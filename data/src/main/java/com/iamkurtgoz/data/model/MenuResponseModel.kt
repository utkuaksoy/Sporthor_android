...
data class MenuResponseModel(
    @SerialName("menu") val menu: List<MenuResponseModelItem>?,
)

@Keep
@Serializable
data class MenuResponseModelItem(
    @SerialName("menuUserType") val menuUserType: Int?,
...
@Serializable
@Keep
data class MenuResponseModelSubItem(
    @SerialName("iconPath") val iconPath: String?,
    @SerialName("name") val name: String?,
    @SerialName("url") val url: String?,
    @SerialName("menuKey") val menuKey: Int?,
