//
//  NotificationNewPostTableViewCell.swift
//  Sporthor
//
...
protocol NotificationNewPostTableViewCellDelegate: AnyObject {
    func didTappedProfileNotificationNewPost(model: NotificationModel)
}

final class NotificationNewPostTableViewCell: UITableViewCell {
    // MARK: - UI Elements
    ...
    // MARK: - Members
    private weak var delegate: NotificationNewPostTableViewCellDelegate?
    ...
    // MARK: - Custom Methods
    func configure(delegate: NotificationNewPostTableViewCellDelegate? = nil,
    ...
    @objc private func didTappedProfile() {
        ...
        delegate?.didTappedProfileNotificationNewPost(model: model)
    }
}
