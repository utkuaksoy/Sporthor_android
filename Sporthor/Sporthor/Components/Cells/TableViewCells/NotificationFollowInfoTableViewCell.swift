//
//  NotificationFollowInfoTableViewCell.swift
//  Sporthor
//
...
protocol NotificationFollowInfoTableViewCellDelegate: AnyObject {
    func didTappedProfileNotificationFollowInfo(model: NotificationModel)
}

final class NotificationFollowInfoTableViewCell: UITableViewCell {
    // MARK: - UI Elements
    ...
    private lazy var stackView: CKStackView = {
        ...
        stackView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(didTappedProfile)))
        return stackView
    }()
    ...
    // MARK: - Members
    private weak var delegate: NotificationFollowInfoTableViewCellDelegate?
    ...
    // MARK: - Custom Methods
    func configure(delegate: NotificationFollowInfoTableViewCellDelegate? = nil,
                   model: NotificationModel) {
        self.delegate = delegate
        self.model = model
        profileImageView.setImage(with: model.image,
    ...
    @objc private func didTappedProfile() {
        ...
        delegate?.didTappedProfileNotificationFollowInfo(model: model)
    }
}
