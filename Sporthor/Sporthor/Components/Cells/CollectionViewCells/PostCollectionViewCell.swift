...
//  Sporthor
//
//  Created by derTurke on 28.03.2025.
//
...
final class PostCollectionViewCell: UICollectionViewCell {
    ...
    // MARK: - Members
    private weak var delegate: PostCollectionViewCellDelegate?
    ...
    func bind(_ model: Post,
              delegate: PostCollectionViewCellDelegate? = nil,
              indexPath: IndexPath) {
...
extension PostCollectionViewCell: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension PostCollectionViewCell: CKPostHeaderViewDelegate {
    func didTappedUsernameInHeaderView(_ username: String, userId: String) {
...
extension PostCollectionViewCell: CKPostActionViewDelegate {
...
extension PostCollectionViewCell: CKPostLikeViewDelegate {
    func didTappedUsernameInLikeView(_ username: String, userId: String) {
...
// MARK: - CKPostLikeViewDelegate
extension PostCollectionViewCell: CKPostCommentViewDelegate {
    func didTappedUsernameInCommentView(_ username: String, userId: String) {
        delegate?.didTappedUsernameInCommentView(username, userId: userId)
    }
}

extension PostCollectionViewCell: ZoomableImageViewCollectionViewCellDelegate {
    func zoomableImageViewCell(_ cell: ZoomableImageViewCollectionViewCell, didLoadImageSize size: CGSize) {}
