//
//  ExperienceJobViewController.swift
//  Sporthor
//
...
final class ExperienceJobViewController: BaseViewController, TabBarVisibility {
    // MARK: - VIPER Variables
    var presenter: ExperienceJobPresenterProtocol {
        get { return self.basePresenter as! ExperienceJobPresenterProtocol }
        set { self.basePresenter = newValue }
    }
    
    // MARK: - UI Elements
    private lazy var progressView: CKProgressView = {
        let progressView = CKProgressView(steps: 4, selectedStep: 2)
    ...
    // MARK: - Members
    private var textStackViewTopCons: NSLayoutConstraint!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        navigationController?.setNavigationBarHidden(!presenter.isEdit, animated: true)
...
// MARK: - ExperienceJobPresenterDelegate
extension ExperienceJobViewController: ExperienceJobPresenterDelegate {
    func prepareUI() {
        ...
        textStackViewTopCons = textStackView.topAnchor.constraint(
    ...
    func updateEditView() {
        ...
        textStackViewTopCons.constant = 24
        progressView.isHidden = true
    }
}

// MARK: - UICollectionViewDataSource
extension ExperienceJobViewController: UICollectionViewDataSource {
...
extension ExperienceJobViewController: UICollectionViewDelegateFlowLayout {
...
extension ExperienceJobViewController: CKButtonDelegate {
    func ckButtonDidTap(tag: Int) {
        presenter.didTappedContinueButton(tag)
    }
}

// MARK: - CustomNavigationControllerDelegate
extension ExperienceJobViewController: CustomNavigationControllerDelegate {
