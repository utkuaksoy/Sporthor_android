//
//  ExperienceBranchViewController.swift
//  Sporthor
//
...
final class ExperienceBranchViewController: BaseViewController {
    // MARK: - VIPER Variables
    var presenter: ExperienceBranchPresenterProtocol {
        get { return self.basePresenter as! ExperienceBranchPresenterProtocol }
        set { self.basePresenter = newValue }
    }
    
    // MARK: - UI Elements
    private lazy var progressView: CKProgressView = {
        let progressView = CKProgressView(steps: 4, selectedStep: 3)
...
// MARK: - ExperienceBranchPresenterDelegate
extension ExperienceBranchViewController: ExperienceBranchPresenterDelegate {
    func prepareUI() {
...
extension ExperienceBranchViewController: UICollectionViewDataSource {
...
extension ExperienceBranchViewController: UICollectionViewDelegateFlowLayout {
...
extension ExperienceBranchViewController: CKButtonDelegate {
