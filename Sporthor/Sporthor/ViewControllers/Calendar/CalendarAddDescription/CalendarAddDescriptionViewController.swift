//
//  CalendarAddDescriptionViewController.swift
//  Sporthor
//
...
final class CalendarAddDescriptionViewController: BaseViewController {
    // MARK: - VIPER Variables
    var presenter: CalendarAddDescriptionPresenterProtocol {
        get { return self.basePresenter as! CalendarAddDescriptionPresenterProtocol }
    ...
    private lazy var titleLabel: CKLabel = {
        let label = CKLabel(text: "Açıklama", textColor: .black, textAlignment: .center , font: .heading06)
...
// MARK: - CalendarAddDescriptionPresenterDelegate
extension CalendarAddDescriptionViewController: CalendarAddDescriptionPresenterDelegate {
    func prepareUI() {
...
extension CalendarAddDescriptionViewController: CKCustomTextViewDelegate {
...
extension CalendarAddDescriptionViewController: CKButtonDelegate {
...
extension CalendarAddDescriptionViewController: PanModalPresentable {
    ...
    var longFormHeight: PanModalHeight {
        ...
        let textViewHeight: CGFloat = 250
        let buttonHeight: CGFloat = 46
        let verticalSpacing: CGFloat = 16 + 16 + 8
